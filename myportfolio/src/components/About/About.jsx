      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            ...
            technology, entrepreneurship, problem solving and business. I'm
            always learning, experimenting, and looking for opportunities to
            create impactful products.
          </p>

          {/* Resume Button (currently commented) */}
          <a
            href="https://drive.google.com/file/d/1ReRmyQoDxz6imVL8DRog1biIrZpn2tke/view?usp=sharing"
            target="_blank"
