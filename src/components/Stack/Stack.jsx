const SKILL_GROUPS = [
  {
    label: "languages",
    items: [
      { name: "javascript", used: "stupify, infinity, iykykprints" },
      { name: "typescript", used: "iykykprints" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "next.js", used: "iykykprints" },
      { name: "tailwind css", used: "stupify, infinity, this site, iykykprints" },
    ],
  },
  {
    label: "backend",
    items: [
      { name: "node.js", used: "iykykprints" },
      { name: "express", used: "" },
      { name: "websockets", used: "doodlydoo" },
      { name: "yjs", used: "doodlydoo" },
      { name: "prisma (orm)", used: "iykykprints" },
      { name: "next-auth (auth.js)", used: "iykykprints" },
      { name: "jose (jwt)", used: "iykykprints" },
      { name: "bcryptjs", used: "iykykprints" },
      { name: "zod", used: "iykykprints" },
    ],
  },
  {
    label: "databases / tools",
    items: [
      { name: "postgresql", used: "doodlydoo, iykykprints (neon)" },
      { name: "mongodb", used: "" },
      { name: "git", used: "every project" },
      { name: "github", used: "every project" },
      { name: "vite", used: "this site" },
      { name: "vercel", used: "iykykprints, this site" },
      { name: "vitest", used: "iykykprints" },
    ],
  },
  {
    label: "integrations",
    items: [
      { name: "razorpay", used: "iykykprints" },
      { name: "cloudinary", used: "iykykprints" },
      { name: "resend", used: "iykykprints" },
    ],
  },
];
